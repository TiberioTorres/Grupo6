...
import Reto3Ciclo3.Reto3Ciclo3.servicio.ServiciosMessage;
...
public class ControllerMessage {
    ...
    @GetMapping("/{id}")
    public Optional<Message> getMessageIndividual (@PathVariable("id") int id){
        return serviciosMessage.getMessageId(id);
    }
